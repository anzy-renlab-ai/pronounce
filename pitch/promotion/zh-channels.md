...
>
> 做了个发音字典 —— 851 个程序员每天会用错的项目名，每条都有出处：
>
...
2. 851 个程序员名词正确读法，附出处（最后一条全网都读错了）
...
>
> 写了一个 CLI 工具 say-it，覆盖 851 个程序员日常踩雷的发音：
>
...
**标题**: [分享创造] Pronounce — 851 条带出处的程序员发音字典
...
**标题**：**程序员发音的"野生权威"——我做了 851 条带出处的发音字典**
