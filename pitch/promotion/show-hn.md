...
Ready-to-post. Numbers current as of v2.15.0: **1738 entries** (158 contested · 67 creator-clarified · 1513 community-consensus). Be honest about traction: ~26 GitHub stars, ~300 extension installs. Don't inflate either.
...
2. **Show HN: 158 dev words you're still arguing about, 67 the creators already settled (with citations)**
3. **Show HN: I cited every pronunciation so we'd stop fighting about GIF on standup (1738 dev terms)**
...
- **creator-clarified (67)** — the person who made the thing said so, on the record:
...
- **contested (158)** — both readings are alive and devs still argue. The dict surfaces *both* and plays them back to back:
...
- **community-consensus (1513)** — widely agreed, no single citable authority. The long tail.

The scoreboard is the fun part: **158 words you're still arguing about, 67 the creators already settled.** That's the screenshot.
...
- The whole dataset, one file (1738 entries): https://github.com/anzy-renlab-ai/pronounce/blob/main/data/pronunciations.tsv
...
3. **Entries I got wrong.** Especially the 158 contested ones — if your team says it a third way, tell me and I'll add the variant rather than pick a winner.
...
> Author here. The thing I actually care about isn't picking winners, it's the scoreboard: of 1738 entries, **158 are contested** (both readings active, dict plays both) and **67 are creator-clarified** with a source URL — GIF/jif (Wilhite, NYT 2013), TOML rhymes-with-knoll (Preston-Werner), Tcl/tickle (Ousterhout), awk/auk. The other 1513 are community-consensus, no single citable authority. I'd love the contested list to get *more* contested — if your team says kubectl a way I don't have, comment it and I'll add the variant instead of overruling you. The whole dataset is one TSV you can grep: [link].
