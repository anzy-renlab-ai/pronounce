...
const ENTRIES = [
  ...
  { w: "muon", ipa: "/ˈmjuːɒn/", r: "MYOO on", aIpa: "", aR: "", url: "https://kellerjordan.github.io/posts/muon/", srcLabel: "Keller Jordan — \"Muon optimizer\"", cat: "cs-term", conf: "community-consensus", notes: "Hidden-layer optimizer (MomentUm Orthogonalized by Newton-schulz) by Keller Jordan, used to set NanoGPT speedrun records and in large-scale pretraining. Pronounced like the subatomic particle: MYOO-on (two syllables), not \"moo-on\" or spelled out M-U-on." },
  { w: "Janus", ipa: "/ˈdʒeɪnəs/", r: "JAY nuhs", aIpa: "", aR: "", url: "https://arxiv.org/abs/2410.13848", srcLabel: "DeepSeek — Janus paper (arXiv 2410.13848)", cat: "product", conf: "community-consensus", notes: "DeepSeek's unified multimodal model (Janus / Janus-Pro) that decouples visual encoding for understanding vs generation. Named after the two-faced Roman god of doorways: JAY-nuhs, stress on the first syllable." },
  { w: "Mochi", ipa: "/ˈmoʊtʃi/", r: "MOH chee", aIpa: "", aR: "", url: "https://www.genmo.ai/blog/mochi-1", srcLabel: "Genmo — Mochi 1 announcement", cat: "product", conf: "community-consensus", notes: "Genmo's open-source text-to-video model (Mochi 1). Pronounced like the Japanese rice cake: MOH-chee, not \"MOTCH-ee\" or \"moh-CHAI\"." },
  { w: "ColPali", ipa: "/koʊlˈpɑːli/", r: "kol PAH lee", aIpa: "", aR: "", url: "https://arxiv.org/abs/2407.01449", srcLabel: "ColPali paper (arXiv 2407.01449)", cat: "cs-term", conf: "community-consensus", notes: "Late-interaction visual document retrieval: ColBERT-style multi-vector matching over PaliGemma image patches. Said kol-PAH-lee — \"Col\" from ColBERT, \"Pali\" from PaliGemma (PAH-lee, the Buddhist canonical language)." },
  { w: "Nunchaku", ipa: "/ˈnʌntʃɑːkuː/", r: "NUN chah koo", aIpa: "", aR: "", url: "https://github.com/mit-han-lab/nunchaku", srcLabel: "MIT Han Lab — nunchaku GitHub", cat: "tool", conf: "community-consensus", notes: "MIT Han Lab's 4-bit inference engine that runs SVDQuant-compressed diffusion models. Named after the martial-arts weapon (nunchucks): NUN-chah-koo." },
  { w: "SVDQuant", ipa: "/ˌɛsviːdiːˈkwɑːnt/", r: "ess vee dee kwant", aIpa: "", aR: "", url: "https://arxiv.org/abs/2411.05007", srcLabel: "SVDQuant paper (arXiv 2411.05007)", cat: "acronym", conf: "community-consensus", notes: "4-bit post-training quantization for diffusion models that shunts weight+activation outliers into a low-rank branch. SVD = Singular Value Decomposition, read letter-by-letter then \"quant\": ess-vee-dee-KWANT." },
  { w: "ModernBERT", ipa: "/ˈmɒdərnbɜːrt/", r: "MOD ern bert", aIpa: "", aR: "", url: "https://arxiv.org/abs/2412.13663", srcLabel: "ModernBERT paper (arXiv 2412.13663)", cat: "product", conf: "community-consensus", notes: "2024 modernized BERT-style encoder (8k context, RoPE, FlashAttention, GeGLU). Spoken MOD-ern-BERT — \"BERT\" as the single word \"bert\", never spelled out B-E-R-T." },
  { w: "Genie", ipa: "/ˈdʒiːni/", r: "JEE nee", aIpa: "", aR: "", url: "https://arxiv.org/abs/2402.15391", srcLabel: "Genie paper (DeepMind, arXiv 2402.15391)", cat: "product", conf: "community-consensus", notes: "DeepMind's foundation world model (Genie 1/2/3) that turns a single image or prompt into a playable, interactive environment. Pronounced like the lamp genie: JEE-nee." },
  { w: "Medusa", ipa: "/məˈduːsə/", r: "muh DOO suh", aIpa: "", aR: "", url: "https://arxiv.org/abs/2401.10774", srcLabel: "Medusa paper (arXiv 2401.10774)", cat: "cs-term", conf: "community-consensus", notes: "Speculative-decoding method that adds multiple extra decoding \"heads\" so a model drafts several future tokens itself (no separate draft model). Named after the Gorgon Medusa with many snake-heads: muh-DOO-suh." },
  { w: "Kontext", ipa: "/ˈkɒntɛkst/", r: "KON text", aIpa: "", aR: "", url: "https://bfl.ai/announcements/flux-1-kontext", srcLabel: "Black Forest Labs — FLUX.1 Kontext", cat: "product", conf: "community-consensus", notes: "Black Forest Labs' in-context image generation+editing model (FLUX.1 Kontext). \"Kontext\" is German for \"context\"; said KON-text, stress on the first syllable." },
  { w: "crate", ipa: "/kreɪt/", r: "krayt", aIpa: "", aR: "", url: "https://doc.rust-lang.org/book/ch07-01-packages-and-crates.html", srcLabel: "The Rust Programming Language Book §7.1", cat: "cs-term", conf: "community-consensus", notes: "Rust's unit of compilation / the package you publish to crates.io. Pronounced exactly like the wooden box \"crate\": KRAYT, one syllable, rhymes with \"great\" and \"plate\". Not \"krah-tay\" or \"crayt-ee\". (Asked by a non-native speaker in Discussion #34.)" },
  { w: "rustc", ipa: "/ˈrʌstsiː/", r: "rust see", aIpa: "/ˈrʌstkeɪ/", aR: "rust kay", url: "https://doc.rust-lang.org/rustc/what-is-rustc.html", srcLabel: "rustc book — \"What is rustc?\"", cat: "cli-tool", conf: "community-consensus", notes: "The Rust compiler. The \"c\" is for \"compiler\" and is almost always read as the letter C: RUST-see (rust + C). A minority say \"rust-cee\" identically; \"rustk\" (one syllable) is heard but uncommon. Compare gcc/clang usage where the trailing letter is spoken." },
  { w: "clippy", ipa: "/ˈklɪpi/", r: "klip ee", aIpa: "", aR: "", url: "https://github.com/rust-lang/rust-clippy", srcLabel: "rust-lang/rust-clippy GitHub", cat: "cli-tool", conf: "community-consensus", notes: "Rust's official linter (run via `cargo clippy`). KLIP-ee — named after Clippy, the Microsoft Office paperclip assistant; same pronunciation as that mascot." },
  { w: "rustup", ipa: "/ˈrʌstʌp/", r: "rust up", aIpa: "", aR: "", url: "https://rust-lang.github.io/rustup/", srcLabel: "rustup book (rust-lang.github.io/rustup)", cat: "cli-tool", conf: "community-consensus", notes: "The Rust toolchain installer and version manager. Read as the two transparent parts: RUST-up (rust + up), stress on the first syllable. Not \"rus-TUP\"." },
  { w: "simplify", ipa: "/ˈsɪmpləfaɪ/", r: "sim pluh fye", aIpa: "", aR: "", url: "https://www.merriam-webster.com/dictionary/simplify", srcLabel: "Merriam-Webster", cat: "cs-term", conf: "community-consensus", notes: "Claude Code /simplify and everyday code review verb; stress the FIRST syllable — \"SIM-pluh-fye\"." },
  { w: "compact", ipa: "/kəmˈpækt/", r: "kum packt", aIpa: "/ˈkɑːmpækt/", aR: "kahm packt", url: "https://www.merriam-webster.com/dictionary/compact", srcLabel: "Merriam-Webster", cat: "cs-term", conf: "community-consensus", notes: "The verb (Claude Code /compact — compact the conversation) stresses the SECOND syllable: \"kum-PAKT\". The adjective/noun (\"a compact format\") stresses the first: \"KAHM-pakt\"." },
  { w: "resume", ipa: "/rɪˈzuːm/", r: "rih zoom", aIpa: "", aR: "", url: "https://www.merriam-webster.com/dictionary/resume", srcLabel: "Merriam-Webster", cat: "cs-term", conf: "community-consensus", notes: "The verb (claude --resume, resume a session): \"rih-ZOOM\". Don't confuse with the noun résumé \"REZ-uh-may\" — different word." },
  { w: "init", ipa: "/ɪˈnɪt/", r: "ih nit", aIpa: "/ˈɪnɪt/", aR: "in it", url: "", srcLabel: "", cat: "cs-term", conf: "contested", notes: "Clipped \"initialize\" (git init, npm init, /init). Most say \"ih-NIT\"; \"IN-it\" also common; some spell it out I-N-I-T." },
  { w: "exec", ipa: "/ɪɡˈzɛk/", r: "ig zek", aIpa: "", aR: "", url: "", srcLabel: "", cat: "cs-term", conf: "community-consensus", notes: "Clipped \"execute\" (codex exec, docker exec, exec()): \"ig-ZEK\"." },
  { w: "sandbox", ipa: "/ˈsændbɑːks/", r: "sand bahks", aIpa: "", aR: "", url: "", srcLabel: "", cat: "cs-term", conf: "community-consensus", notes: "Isolated execution environment: \"SAND-bahks\"." },
  { w: "headless", ipa: "/ˈhɛdləs/", r: "hed luss", aIpa: "", aR: "", url: "", srcLabel: "", cat: "cs-term", conf: "community-consensus", notes: "Headless browser / headless CMS: \"HED-luss\"." },
  { w: "deprecate", ipa: "/ˈdɛprəkeɪt/", r: "dep ruh kayt", aIpa: "", aR: "", url: "https://www.merriam-webster.com/dictionary/deprecate", srcLabel: "Merriam-Webster", cat: "cs-term", conf: "community-consensus", notes: "\"DEP-ruh-kayt\" — three syllables, no \"-shee-\". Often mixed up with \"depreciate\" (deh-PREE-shee-ayt), which is a different word." },
  { w: "review", ipa: "/rɪˈvjuː/", r: "rih vyoo", aIpa: "", aR: "", url: "", srcLabel: "", cat: "cs-term", conf: "community-consensus", notes: "Code review, /review: \"rih-VYOO\", stress the second syllable." },
  { w: "commit", ipa: "/kəˈmɪt/", r: "kuh mit", aIpa: "", aR: "", url: "", srcLabel: "", cat: "cs-term", conf: "community-consensus", notes: "git commit: \"kuh-MIT\", stress the second syllable." },
  { w: "rebase", ipa: "/ˈriːbeɪs/", r: "ree bayss", aIpa: "", aR: "", url: "", srcLabel: "", cat: "cs-term", conf: "community-consensus", notes: "git rebase: \"REE-bayss\"." },
];
