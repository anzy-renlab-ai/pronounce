...
const ENTRIES = [
  ...
  { w: "QUIC", ipa: "/kwɪk/", r: "quick", aIpa: "/ˌkjuː juː aɪ ˈsiː/", aR: "Q U I C", url: "https://datatracker.ietf.org/doc/html/rfc9000", srcLabel: "IETF RFC 9000", cat: "acronym", conf: "creator-clarified", notes: "IETF + Google docs: \"quick\". From \"Quick UDP Internet Connections\"." },
  ...
  { w: "YAML", ipa: "/ˈjæməl/", r: "yam ul", aIpa: "/ˈjeɪməl/", aR: "yay mul", url: "https://yaml.org/faq.html", srcLabel: "yaml.org FAQ", cat: "acronym", conf: "creator-clarified", notes: "yaml.org FAQ: \"rhymes with camel\". YAM-uhl." },
  ...
  { w: "HTTPie", ipa: "/ˌeɪtʃ tiː tiː piː ˈaɪ/", r: "H T T P aye", aIpa: "/ˌeɪtʃ tiː tiː ˈpaɪ/", aR: "H T T P pie", url: "https://httpie.io/docs/cli", srcLabel: "HTTPie docs", cat: "cli-tool", conf: "creator-clarified", notes: "\"aitch-tee-tee-pie\" — like the suffix \"-ie\" in English." },
  ...
  { w: "Dijkstra", ipa: "/ˈdaɪk strɑː/", r: "DIKE strah", aIpa: "/ˈdɪk strə/", aR: "DICK struh", url: "https://www.cs.utexas.edu/users/EWD/", srcLabel: "Edsger Dijkstra archive", cat: "cs-term", conf: "creator-clarified", notes: "Dutch: \"DIKE-strah\". Edsger himself corrected English speakers many times." },
  ...
  { w: "Tcl", ipa: "/ˈtɪkəl/", r: "tickle", aIpa: "/ˌtiː siː ˈɛl/", aR: "T C L", url: "https://www.tcl-lang.org/", srcLabel: "Tcl official", cat: "product", conf: "creator-clarified", notes: "John Ousterhout (creator): \"tickle\". Official Tcl Developer Xchange confirms." },
  { w: "awk", ipa: "/ɔːk/", r: "auk", aIpa: "/ˌeɪ dʌbəl juː ˈkeɪ/", aR: "A double you K", url: "https://en.wikipedia.org/wiki/AWK#Origin_of_the_name", srcLabel: "Wikipedia § Origin of the name", cat: "cli-tool", conf: "creator-clarified", notes: "\"auk\" — like the seabird, rhymes with \"hawk\". Named after creators' initials (Aho/Weinberger/Kernighan); pronunciation confirmed in original AWK book." },
  ...
  { w: "scrypt", ipa: "/ɛs ˈkrɪpt/", r: "S crypt", aIpa: "/skrɪpt/", aR: "skript", url: "https://www.tarsnap.com/scrypt.html", srcLabel: "Colin Percival (creator)", cat: "cs-term", conf: "creator-clarified", notes: "Creator Colin Percival: \"ess-crypt\" (S then crypt). \"script\" is common but not the intent." },
  ...
  { w: "io_uring", ipa: "/ˌaɪ oʊ ˈjʊər ɪŋ/", r: "I O YOUR ing", aIpa: "/ˌaɪ oʊ ˈʊər ɪŋ/", aR: "I O OOR ing", url: "https://kernel.dk/io_uring.pdf", srcLabel: "Jens Axboe paper", cat: "cs-term", conf: "creator-clarified", notes: "Jens Axboe: \"I-O ring\" (the underscore is silent). Async I/O syscall API." },
