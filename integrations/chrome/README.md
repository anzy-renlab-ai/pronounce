...
Click any tech word on any web page — hear how engineers actually say it. 1883-entry confidence-tagged dictionary, the same one that powers the [CLI](../../bin/say-it), [VS Code extension](https://open-vsx.org/extension/sayit/pronounce), and [Pronounce.ai](https://pronounce.renlab.ai/).
...
- **Toolbar popup** — fuzzy-search all 1883 entries with `↑↓ Enter`.
