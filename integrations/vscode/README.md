...
- **Search dictionary** — fuzzy-find any of the 1790 entries from the command palette (`⌘⇧P` → "Pronounce").
...
**程序员单词怎么读？** 在 VS Code / Cursor / Windsurf 里**悬停**任意技术词 — `kubectl`、`nginx`、`YAML`、`Pydantic`、`Ollama` … — 直接听到工程师实际的读法，附 IPA、英式拼读和**来源引用**。1790 条社区维护词条，覆盖产品名、命令行工具、AI/ML 项目与研究者。
...
- **Web**: [pronounce.renlab.ai](https://pronounce.renlab.ai/) — full 1790-entry browser with Famous Moments + quiz.
